...
public class TestYamlFormatter
{
  ...
  public IPipeWriter _Writer;

  public TestYamlFormatter()
  {
    _TextWriter = new StringWriter();
    _Writer = new TextPipe(_TextWriter);
  }
...
";
    ...
    IYamlHierarchy subject = new YamlFormatter(_Writer);
...
";
  ...
  public void ShortComment_truncates_long_statements_at_space()
  {
    ...
    IYamlValues subject = new YamlFormatter(_Writer);
